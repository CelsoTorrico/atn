<?php 
     ...
     * Template de Email
     * 
     * Bem vindo a plataforma AtletasNOW
     * @since 2.1
     *  
     */
    ...
    <html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
        <head>
            ...
            <title>Bemvindo a plataforma AtletasNOW</title>
    ...
    <br>
    <span style="font-size:24px"><strong>Bemvindo, '. $data['name'] . '</strong></span></p>
                ...
                <td valign="top" class="mcnTextBlockInner" style="padding-top:9px;">
                    ...
                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                        <tbody><tr>
                            ...
                            <td valign="top" class="mcnTextContent" style="padding: 0px 18px 9px;color: #5C5C5C;">
                            
                                <h3 style="text-align: center;"><span style="color:#808080"><span style="font-size:13px">Mantenha contato, aumente seu networking e encontre oportunidades!</span></span></h3>
                    ...
                    <table align="left" border="0" cellpadding="0" cellspacing="0" style="max-width:100%; min-width:100%;" width="100%" class="mcnTextContentContainer">
                        <tbody><tr>
                            ...
                            <td valign="top" class="mcnTextContent" style="padding-top:0; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                ...
                                <div style="text-align: center;">Nossa plataforma conecta todas as pontas do esporte através de um meio digital e inovador. Nós somos o networking esportivo para quem quer se destacar no mundo dos esportes.<br>
    <br>
    <img data-file-id="3982613" height="18" src="https://atletasnow.com/wp-content/themes/nova_atletasnow/assets/images/logo-cor-2.png" style="border: 0px  ; width: 150px; height: 18px; margin: 0px;" width="150"><br>
    <br>
    © 2019 - AtletasNow</div>

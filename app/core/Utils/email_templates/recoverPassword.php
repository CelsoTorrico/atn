<?php 
    ...
    <html xmlns="http://www.w3.org/1999/xhtml" xmlns:v="urn:schemas-microsoft-com:vml" xmlns:o="urn:schemas-microsoft-com:office:office">
        <head>
            ...
            <title>Mensagem para você - AtletasNOW</title>
    ...
    <p style="text-align: center;">Os melhores atletas do Brasil estão aqui.<br></p>
                        ...
                        <table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                            <tbody><tr>
                                ...
                                <h1 style="font-family:Axiforma;color:#d03014;">Nova senha de acesso gerada!</h1>
                                    ...
                                    <p style=""><font size="5">' . $data['newpass'] . '</font></p>
                                    <p style="color:#444;font-size:14px;"><br /><br />Suporte AtletasNOW</p>
                                </td>
                            </tr>
                        </tbody></table>
                    </td>
